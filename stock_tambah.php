...
<body>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
					...
					<li class="nav-item">
						<a class="nav-link active" aria-current="page" href="stock_tampil.php">Stock Barang</a>
					</li>
					<li class="nav-item">
	...
	<div class="container-xl mt-4 p-5  bg-light">
		...
		<h5>Tambah Data Stock Barang</h5>

		<!-- fungsi untuk menambah data melalui form -->
		<form action="stock_tambahproses.php" method="POST">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control mt-1 mb-1" name="nama_barang" id="nama_barang">
				</div>
			</div>
			<div class="form-group row">
				<label for="deskripsi" class="col-sm-2 col-form-label">Deskripsi</label>
				<div class="col-sm-10">
					<input type="text" class="form-control mt-1 mb-1" name="deskripsi" id="deskripsi">
				</div>
			</div>
			<div class="form-group row">
				<label for="stock" class="col-sm-2 col-form-label">Unit</label>
				<div class="col-sm-10">
					<input type="number" class="form-control mt-1 mb-1" name="unit" id="unit">
				</div>
			</div>
			<div class="form-group row">
				<div class="col-sm-10">
