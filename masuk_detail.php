...
<body>
	...
	<div class="container-xl mt-4 p-5  bg-light">
	  <h1 align="left mb-2">Detail Barang Masuk</h1><hr>
		<h4>
			...
			?>
			  ...
			  <div class="form-group row">
			    ...
			    <div class="col-sm-10">
			    <input type="text" class="form-control mt-1 mb-1" name="tanggal" id="tanggal" value="<?php echo $baris['tanggal']; ?>">
				</div>
			  </div>
			  <div class="form-group row">
			    <label for="penerima" class="col-sm-2 col-form-label">Keterangan</label>
			    <div class="col-sm-10">
			    <p class="form-control mt-1 mb-1"><?php echo $baris['penerima']; ?></p>
				</div>
			  </div>
			</form>
	</div>
