...
<body>
	...
	<div class="container-xl mt-4 p-5  bg-light">
	  <h1 align="left mb-2">Menu Barang Keluar</h1><hr>
		<h4>
			<a href="keluar_tampil.php" class="btn btn-outline-info">Lihat Data Barang Keluar</a>
		</h4>
		 <h5>Edit Data Barang Keluar</h5>
			...
			$data = mysqli_query($koneksi, "SELECT * FROM br_keluar WHERE id_keluar='$id_keluar'");
			$baris = mysqli_fetch_array($data);
			?>

			<form action="keluar_editproses.php?id_keluar=<?= $id_keluar ?>" method="POST">
			  <div class="form-group row">
			    <label for="id_keluar" class="col-sm-2 col-form-label">ID Keluar</label>
			    <div class="col-sm-10">
			    <input type="text" class="form-control mt-1 mb-1" name="id_keluar" id="id_keluar" value="<?php echo $baris['id_keluar']; ?>" disabled>
				</div>
			  </div>
			  <div class="form-group row">
			  ...
			  <div class="form-group row">
			    ...
			    <div class="col-sm-10">
			    <input type="text" class="form-control mt-1 mb-1" name="keterangan" id="keterangan" value="<?php echo $baris['keterangan']; ?>">
				</div>
			  </div>
			  <div class="form-group row">
				 <div class="col-sm-10">
