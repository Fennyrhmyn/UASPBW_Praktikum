...
<body>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
					...
					<li class="nav-item">
						<a class="nav-link active" aria-current="page" href="keluar_tampil.php">Barang Keluar</a>
					</li>
	...
	<div class="container-xl mt-4 p-5  bg-light">
		...
		<form action="keluar_tambahproses.php" method="POST">
			<div class="form-group row">
				<label for="id_keluar" class="col-sm-2 col-form-label">ID Keluar</label>
				<div class="col-sm-10">
					<input type="text" class="form-control mt-1 mb-1" name="id_keluar" id="id_keluar">
				</div>
			</div>		
			<div class="form-group row">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control mt-1 mb-1" name="keterangan" id="keterangan">
				</div>
			</div>
			<div class="form-group row">
				<div class="col-sm-10">
