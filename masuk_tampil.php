...
<body>
	...
	<div class="container-xl mt-4 p-5  bg-light">
	  <h1 align="left mb-2"b >Menu Barang Masuk</h1><hr>
	   <p>Berikut dibawah ini merupakan data barang masuk di <b>7'Corp!</b></p>
		<h4>
			<a href="masuk_tambah.php" class="btn btn-info">Tambah Data</a>
		</h4>
		...
		<table class="table table-striped table-bordered table-hover align-middle">
			...
			<tbody>
				...
				include("koneksi.php");
				$no = 0;
				$data = mysqli_query($koneksi, "SELECT * FROM br_masuk");
				...
				<tr>
					...
					<td>
						...
						<?php
			            if($_SESSION['level'] == "admin" ) { ?>
							<a href="masuk_edit.php?id_masuk=<?= $baris['id_masuk']; ?>" class="btn btn-warning">Edit</a>
							<a href="masuk_detail.php?id_masuk=<?= $baris['id_masuk']; ?>" class="btn btn-info">Detail</a>
							<a href="masuk_hapus.php?id_masuk=<?= $baris['id_masuk']; ?>" class="btn btn-danger">Hapus</a>
						<?php
			            }
			            elseif($_SESSION['level'] == "karyawan") {
			            ?>
